<div id="modalAddress" class="fixed z-10 inset-0 overflow-y-auto transition duration-200 invisible h-0 opacity-0">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20
        ...
        class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
                    ...
                    <form action="{{ route('my-account.address.store-redirect') }}" method="post" id="newAddressForm"
                        ...
                        <div class="block mb-6 lg:col-span-full">
                            ...
                            <div class="mt-2 flex space-x-5">
                                <x-input-checkbox label="ya" value="1" id="ya-option" 
                                name="is_main_address" />
                                <x-input-checkbox label="ya" value="0" id="ya-option" 
                                name="is_main_address" checked />
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 flex justify-between">
                <a href="javascript:void(0);" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium
                text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2
                focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto
                sm:text-sm btn-modal-address">
                    Cancel
                </a>
                <button type="submit" form="newAddressForm" class="w-full inline-flex justify-center rounded-md border border-transparent
                    ...
                    focus:ring-red-500 sm:w-auto sm:text-sm next-step">
                    Submit
                </button>
            </div>
        </div>
