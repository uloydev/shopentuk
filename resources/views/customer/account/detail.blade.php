...
@section('content')
    ...
    <div class="block">
        ...
        <form action="">
            ...
            <div class="bg-white shadow-md p-5 mb-5">
                <button type="button" class="btn bg-green-600 btn-sm m-2 btn-edit-address" id="newAddressBtn">tambah alamat</button>
    ...
    {{-- please remove hidden class when js fixed --}}
    <div id="modalNewAddress" class="fixed z-10 inset-0 overflow-y-auto transition duration-200 hidden">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20
            text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
            ...
            <div role="dialog" aria-modal="true" aria-labelledby="modal-headline" class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
                        ...
                        <form action="{{route('my-account.address.store')}}" method="post" id="newAddressForm"
                            ...
                            <div class="block mb-6 lg:col-span-full">
                                ...
                                <div class="mt-2 flex">
                                    ...
                                    <div class="ml-2">
                                        <label class="inline-flex items-center">
                                            <input type="radio" class="form-radio" name="is_main_address" value="0">
                                            <span class="ml-2">
                                                tidak
                                            </span>
                                        </label>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium
                        text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2
                        focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto
                        sm:text-sm" id="btn-close-modalNewAddress">
                        Cancel
                    </button>
                </div>
            </div>
...
@push('script')
    <script>
        ...
        connew = document.querySelector('#editAddressForm');
        ...
        newAddressBtn.addEventListener('click' () => {
            // please fix open modal
            // openCloseModal('#modalNewAddress')
        })
