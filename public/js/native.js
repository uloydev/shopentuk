...
var pageOriginUrl = window.location.origin;
...
btnOpenChildMenu.forEach(function (openChild) {
  ...
  openChild.addEventListener('click', function (e) {
    e.preventDefault();
    var siblingsChild = _helper_js__WEBPACK_IMPORTED_MODULE_2__["getSiblings"](openChild.parentNode);
...
if (pageUrl === '/payment/cart') {
  ...
  cartQtyInput.forEach(function (input) {
    ...
    input.addEventListener('keyup', function () {
      ...
      cartItemPriceEl.textContent = _helper_js__WEBPACK_IMPORTED_MODULE_2__["formattingRupiah"](cartItemInitPrice * currentQtyInput);
    });
  });
  ...
  cartSubTotal.textContent = _helper_js__WEBPACK_IMPORTED_MODULE_2__["formattingRupiah"](totalPriceWithoutShipping);
  ...
  cartGrandTotal.textContent = _helper_js__WEBPACK_IMPORTED_MODULE_2__["formattingRupiah"](cartShipping + totalPriceWithoutShipping);
