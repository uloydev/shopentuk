...
/*!************************************************!*\
  !*** ./resources/assets/js/component/modal.js ***!
  \************************************************/
/*! exports provided: openCloseModalAddress */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openCloseModalAddress", function() { return openCloseModalAddress; });
...
var openCloseModalAddress = function openCloseModalAddress() {
  if (document.querySelectorAll('.btn-open-close-modal-address')) {
    var btnAddNewAddress = document.querySelectorAll('.btn-open-close-modal-address');
    btnAddNewAddress.forEach(function (btn) {
      btn.addEventListener('click', function () {
        _helper_module__WEBPACK_IMPORTED_MODULE_0__["openCloseModal"]('#modalAddAddress');
      });
    });
  }

  if (document.querySelectorAll('.btn-edit-addresss')) {
    var btnEditAddress = document.querySelectorAll('.btn-edit-addresss');
    btnEditAddress.forEach(function (btnEdit) {
...
/* harmony import */ var _component_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../component/modal */ "./resources/assets/js/component/modal.js");
...
/* harmony import */ var _helper_utilities__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../helper-utilities */ "./resources/assets/js/helper-utilities.js");
...
if (_helper_module__WEBPACK_IMPORTED_MODULE_2__["pageUrl"] === '/cart') {
  ...
  if (cartPage.querySelector('#modalCheckout')) {
    ...
    btnShowCheckoutStep.addEventListener('click', function () {
      Object(_helper_module__WEBPACK_IMPORTED_MODULE_2__["openCloseModal"])('#modalCheckout');
    });
    var btnCloseModal = cartPage.querySelector('#closeModalCheckout'); // when user close the modal

    btnCloseModal.addEventListener('click', function () {
      Object(_helper_module__WEBPACK_IMPORTED_MODULE_2__["openCloseModal"])('#' + modalCheckout.getAttribute('id'));
      openStep(firstStep);
    ...
    btnsManageModalAddress.forEach(function (btnOnModalAddNewAddress) {
      btnOnModalAddNewAddress.addEventListener('click', function () {
        Object(_helper_module__WEBPACK_IMPORTED_MODULE_2__["openCloseModal"])('#modalAddAddress');
      });
        ...
        if (item.value == 0) {
          if (window.confirm('Anda yakin ingin menghapus produk dari cart ?')) {
            fetch("/cart/".concat(cartId), {
              ...
              Object(_helper_utilities__WEBPACK_IMPORTED_MODULE_3__["getParents"])(item, '.cart-item')[0].remove();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _component_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component/modal.js */ "./resources/assets/js/component/modal.js");
/* harmony import */ var _helper_module_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../helper-module.js */ "./resources/assets/js/helper-module.js");



if (_helper_module_js__WEBPACK_IMPORTED_MODULE_1__["pageUrl"].indexOf('/my-account') > -1) {
  var tabsMenu = document.querySelectorAll('.dashboard-customer__menu-link');
  var pageUrlWithoutProtocol = _helper_module_js__WEBPACK_IMPORTED_MODULE_1__["getUrlWithoutProtocol"](window.location.href);
  tabsMenu.forEach(function (menu) {
    var tabLinkMenu = _helper_module_js__WEBPACK_IMPORTED_MODULE_1__["getUrlWithoutProtocol"](menu.getAttribute('href'));
  ...
  if (_helper_module_js__WEBPACK_IMPORTED_MODULE_1__["pageUrl"] === '/my-account/point') {
  ...
  if (_helper_module_js__WEBPACK_IMPORTED_MODULE_1__["pageUrl"] === '/my-account/detail') {
    Object(_component_modal_js__WEBPACK_IMPORTED_MODULE_0__["openCloseModalAddress"])();
  }
}
